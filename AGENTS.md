...
in sync (currently **1.12.6**). What’s New lives in `lib/core/meta_systems.dart`.
...
closed Alpha (historical upload noted as AAB **14 / 1.9.3**); tagged GitHub line is **1.12.0**, working ship **1.12.6**.
