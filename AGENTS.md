...
in sync (currently **1.12.66**). What’s New lives in `lib/core/meta_systems.dart`.
...
closed Alpha (**1.12.60 / 90** submitted 2026-08-25; testers may still be on
**1.12.52 / 82** until review publishes). Working ship is
**1.12.66**. Production still needs **12 closed testers × 14 days**.
