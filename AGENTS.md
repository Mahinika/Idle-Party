...
in sync (currently **1.12.161**). What’s New lives in `lib/core/meta_systems.dart`.
...
live **1.12.133 / 163**; **1.12.157 / 187** submitted 2026-09-12; working ship **1.12.161 / 191**). Closed opt-in remains for early builds.
