...
| Store listing copy (EN) | ⏳ review | Default locale **en-US only**. Short + full from `docs/STORE_LISTING.md`. **2026-09-16:** full description SHOP line now names forever SCROLLS; submitted (Ändringarna granskas). Phone shots 1–2 recaptured locally (`tool/store_listing/out/01_01_combat_a.png`); Console carousel still the 2026-09-12 set until a later attach. |
