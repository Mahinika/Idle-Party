...
| Production | ❌ | **12×14 unlocks ~2026-09-04** (owner: testers complete tomorrow). Still not live — wait for owner play of **1.12.85** + A56 phone screenshots before production AAB. |
...
- [ ] Owner played **1.12.85+** on A56 before uploading production AAB
