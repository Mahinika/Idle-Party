...
| Closed testing | ✅ Alpha | **1.12.10 (40)** submitted 2026-08-16 (Closed testing – Alpha, in review / pre-checks). Live Alpha until then: **1.12.9 (39)**. GitHub ship line **1.12.0**. Production still ❌. |
...
- [x] Keep Alpha AAB roughly near GitHub ship line when you care about Play testers. **1.12.10 (40)** submitted 2026-08-16 (closed Alpha review; was **1.12.9 (39)** live).
