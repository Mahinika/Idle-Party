...
| Production | ✅ live | **1.12.186 (216)** uploaded + production track committed **2026-09-25** (status `completed`, full rollout — Google may still show review briefly). Previous live was **1.12.184 (214)**. |
