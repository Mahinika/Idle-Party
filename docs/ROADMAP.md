...
Brassvault Deep (14th zone) after Blightfen Mire, plus 1.11.5 chase/kits/Rimeglass.
...
| Content | **31 specs / 14 zoner** (through `brass` Brassvault Deep) | Klass-tungt historiskt; nya zoner mer sällan |
...
**Inventarie:** **14 zoner** through Brassvault ([lib/models/dungeon_def.dart](../lib/models/dungeon_def.dart)), 10 klasser / 31 specs, ~259 abilities, 4 legacy tickers + 27 runner-kits, Infinity Gauntlet AL10+, `LocalSeasonCatalog`, floor blueprint / room chests, balance harness ([tool/sim_harness.dart](../tool/sim_harness.dart) live/afk/bare).
