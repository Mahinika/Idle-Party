...
9. **Endgame ladder (party Lv100)** — after KEY +20: week ALMOST (if any) → Gauntlet (PB after F100) → Greater Rift through GR20 → Rift → Ashen Crown. Ranked GR past 20 is KEY-tab / fallback push so weekly Ashen is not buried. Month ALMOST after ladder. One hunt — not Daily/Will shuffle. Gauntlet is **not** a 16th PATH cave.
