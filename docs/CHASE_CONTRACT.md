...
2. **First hour** — no boss and no Ascend yet: **grow the party** in the recommended zone. After the first floor clear, the hunt names the **next floor** (and boss floor) so the hub does not still say “Enter the cave.” Beats Meet kit / EQUIP / MARKET. Skip Daily / KEY / vault-start / Will grind so TODAY is not a meta list. Skip kit teasers until after the first boss.
