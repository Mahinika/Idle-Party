...
4. **Progress grind** — daily run, vault start, unlock zone, Will, Gauntlet, week goal, push floors  

ALMOST always beats Daily / vault-start grind. Never invent a second priority list in UI.
