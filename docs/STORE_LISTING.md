...
Working ship: **1.12.181+211** (`pubspec.yaml`). Last Play Production paste was **1.12.172+202** submitted **2026-09-17** — do not reuse that line for a new AAB:
...
- **Production AAB:** **1.12.172+202** submitted **2026-09-17** (full rollout).
  In-repo working ship is **1.12.181+211** — do not upload without owner ask.
