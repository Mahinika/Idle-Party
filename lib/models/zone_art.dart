  ...
  static ZoneArtDef _customZone({
    ...
    int verticalSpreadBoost = 3,
      ...
      ZoneArtDef(
        ...
        enemies: enemies,
        wall: wall ?? CustomAssets.dungeonTile(id, 'wall_a'),
  ...
  static final Map<String, ZoneArtDef> _byId = {
    'sandy': _customZone(
      ...
      enemies: ZoneEnemyArt(
        ...
        elite: CustomAssets.enemySandyBrute,
        trash: CustomAssets.enemySlime,
        swarm: CustomAssets.enemySandyMite,
        brute: CustomAssets.enemySandyBrute,
        tank: CustomAssets.enemySandyTank,
        ranged: CustomAssets.enemySandyRanged,
    ...
    'goblin': _customZone(
      ...
      enemies: ZoneEnemyArt(
        ...
        elite: CustomAssets.enemyGoblinElite,
        trash: CustomAssets.enemyGoblinMite,
        swarm: CustomAssets.enemyGoblinMite,
        brute: CustomAssets.enemySpider,
        tank: CustomAssets.enemyGoblinTank,
        ranged: CustomAssets.enemyGoblinRanged,
        glass: CustomAssets.enemySnake,
        support: CustomAssets.enemyCultist,
      ),
    ),
    'king': _customZone(
      ...
      enemies: ZoneEnemyArt(
        boss: CustomAssets.enemyBossKing,
        elite: CustomAssets.enemyKingGuard,
        trash: CustomAssets.enemyKingMite,
        swarm: CustomAssets.enemyKingMite,
        brute: CustomAssets.enemyKingGuard,
        tank: CustomAssets.enemyKingTank,
    ...
    'underworld': _customZone(
      ...
      enemies: ZoneEnemyArt(
        ...
        elite: CustomAssets.enemyUnderworldElite,
    ...
    'hell': _customZone(
      ...
      enemies: ZoneEnemyArt(
        ...
        elite: CustomAssets.enemyHellElite,
    ...
    'crystal': _customZone(
      ...
      corridorShade: Color(0x40204078),
      normalRoomChestChance: 0.12,
      landmarkPerChamber: 2,
      enemies: ZoneEnemyArt(
    ...
    'tide': _customZone(
      ...
      corridorShade: Color(0x40102830),
      preferChoke: true,
      preferTreasureAlcove: true,
    ...
    'ember': _customZone(
      ...
      corridorShade: Color(0x50301808),
      preferChoke: true,
      preferTreasureAlcove: false,
      treasureAlcoveChance: 0.0,
      normalRoomChestChance: 0.18,
    ...
    'grove': _customZone(
      ...
      corridorShade: Color(0x40183010),
      preferChoke: true,
      normalRoomChestChance: 0.12,
    ...
    'storm': _customZone(
      ...
      corridorShade: Color(0x40102048),
      preferChoke: true,
    ...
    'rime': _customZone(
      ...
      corridorShade: Color(0x40183848),
      preferTreasureAlcove: true,
    ...
    'fen': _customZone(
      ...
      corridorShade: Color(0x40282808),
      preferChoke: true,
      normalRoomChestChance: 0.12,
      landmarkPerChamber: 2,
      enemies: ZoneEnemyArt(
    ...
    'veil': _customZone(
      ...
      corridorShade: Color(0x40201838),
      preferChoke: true,
