...
/// Diablo Greater Rift–style timed kill challenge (AL20 endgame).
///
/// Kill [killTarget] enemies before [parTimeMs] expires. Success unlocks the
/// next tier (+2 if finished with ≥25% time remaining). SpatialCombat stays
/// the fight authority — this module is rules + payout only.
