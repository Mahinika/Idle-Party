...
export 'game_storage.dart';

part 'combat_loop.dart';
part 'director_forge.dart';
part 'director_meta_actions.dart';
part 'director_bag.dart';
...
class GameDirector extends ChangeNotifier {
  ...
  void spatialTick() => tickDungeonClock();
