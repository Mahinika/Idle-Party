  ...
  static const List<ChangelogRelease> releases = <ChangelogRelease>[
    ...
    ChangelogRelease(
      ...
      bullets: <String>[
        ...
        'After the first cave, keep leveling the party — the extra hunts wait until everyone is Lv100. Caves stay snappier in crowded fights, and stacked mobs unstick instead of gluing together. Race still locks after New Game START. KEYSTONE waits until the party is Lv100. Ranked GREATER GR packs still scale with rank only — GOLD forge does not buff monsters. After GR20 each rank multiplies toughness so GR239 is not GR25. World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). Prestige Ascend still Rebuild your bag; AL20 BLESSING still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.184',
      bullets: <String>[
        ...
        'Caves stay snappier in crowded fights, and stacked mobs unstick instead of gluing together. Race still locks after New Game START. KEYSTONE waits until the party is Lv100. Ranked GREATER GR packs still scale with rank only — GOLD forge does not buff monsters. After GR20 each rank multiplies toughness so GR239 is not GR25. World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). Prestige Ascend still Rebuild your bag; AL20 BLESSING still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.183',
    ...
    ChangelogRelease(
      ...
      bullets: <String>[
        'Your party fights on its own. After the first cave, keep leveling the party — the extra hunts wait until everyone is Lv100.',
        'Sandy packs spit and crash; the first boss winds up then SLAM. New Game LOOK picks a race (Human through Goblin) per hero — it stays locked after START. Form kits keep their silhouette. KEYSTONE waits until the party is Lv100. Ranked GREATER GR packs still scale with rank only — GOLD forge does not buff monsters. After GR20 each rank multiplies toughness so GR239 is not GR25. World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). Prestige Ascend still Rebuild your bag; AL20 BLESSING still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.180',
      bullets: <String>[
        'Your party fights on its own. After the first cave, keep leveling the party — the extra hunts wait until everyone is Lv100.',
        'Sandy packs spit and crash; the first boss winds up then SLAM. New Game and GEAR LOOK pick a race (Human through Goblin) per hero. Form kits keep their silhouette. KEYSTONE waits until the party is Lv100. Ranked GREATER GR packs still scale with rank only — GOLD forge does not buff monsters. After GR20 each rank multiplies toughness so GR239 is not GR25. World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). Prestige Ascend still Rebuild your bag; AL20 BLESSING still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.179',
      bullets: <String>[
        'Your party fights on its own. After the first cave, keep leveling the party — the extra hunts wait until everyone is Lv100.',
        'New Game and GEAR LOOK pick a race (Human through Goblin) per hero. Form kits keep their silhouette. KEYSTONE waits until the party is Lv100. Ranked GREATER GR packs still scale with rank only — GOLD forge does not buff monsters. After GR20 each rank multiplies toughness so GR239 is not GR25. World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). Prestige Ascend still Rebuild your bag; AL20 BLESSING still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.178',
    ...
    ChangelogRelease(
      ...
      bullets: <String>[
        'Your party fights on its own. After the first cave, keep leveling the party — the extra hunts wait until everyone is Lv100.',
        'Ranked GREATER GR1–20 follow rank only — a fat GOLD forge no longer walls the first step. After GR20 packs climb with rank and ATK/HASTE so GR239 is not GR25. World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). Prestige Ascend still Rebuild your bag; AL20 BLESSING still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.176',
      bullets: <String>[
        'Your party fights on its own. After the first cave, keep leveling the party — the extra hunts wait until everyone is Lv100.',
        'Ranked GREATER GR packs now scale with rank and with a fat GOLD forge (ATK + HASTE) — GR200 is not GR25. World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). Prestige Ascend still Rebuild your bag; AL20 BLESSING still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.175',
      bullets: <String>[
        'Your party fights on its own. After the first cave, keep leveling the party — the extra hunts wait until everyone is Lv100.',
        'Ranked GREATER GR past 20 still uses the 90s clock, but packs keep getting tougher — GR250 is no longer GR25. World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). Prestige Ascend still Rebuild your bag; AL20 BLESSING still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.174',
    ...
    ChangelogRelease(
      ...
      bullets: <String>[
        'Your party fights on its own. After the first cave, keep leveling the party — the extra hunts wait until everyone is Lv100.',
        'KEY this week borrows another cave’s pack jobs and boss tell (PATH art stays). Farm Rift is still a Stormwake kill quota. Gauntlet bosses still cycle tells every 5 floors. Ranked GREATER Rifts: gold mid-run, no gear; Play board on a Play install + sign-in (local PB still on hub). World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). KEY and Farm Rift keep going past 20. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.167',
      bullets: <String>[
        'Your party fights on its own. After the first cave, keep leveling the party — the extra hunts wait until everyone is Lv100.',
        'KEY this week borrows another cave’s pack jobs and boss tell (PATH art stays). Farm Rift is still a Stormwake kill quota. Gauntlet bosses still cycle tells every 5 floors. Ranked GREATER Rifts: gold mid-run, no gear; local PB until a Play board ID exists. World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). KEY and Farm Rift keep going past 20. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.166',
      bullets: <String>[
        'Your party fights on its own. After the first cave, keep leveling the party — the extra hunts wait until everyone is Lv100.',
        'Gauntlet bosses cycle a different tell every 5 floors (SHARD, WAVE, WIND-UP, …). Ranked GREATER Rifts: gold mid-run, no gear; local PB until a Play board ID exists. World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). KEY and Farm Rift keep going past 20. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.165',
      bullets: <String>[
        'Your party fights on its own. After the first cave, keep leveling the party — the extra hunts wait until everyone is Lv100.',
        'Ranked GREATER GR on hub ENDGAME is the next rank after your best (GR34 → GR35) — no KEY dial. Ashen Crown still visits a different shipped cave each week. World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). KEY and Farm Rift keep going past 20. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.164',
      bullets: <String>[
        'Your party fights on its own. After the first cave, keep leveling the party — the extra hunts wait until everyone is Lv100.',
        'Ashen Crown visits a different shipped cave each week — same tickets, not a 16th dungeon. World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). KEY, Farm Rift, and Ranked GREATER Rifts keep going past 20. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.163',
    ...
    ChangelogRelease(
      version: '1.12.161',
      bullets: <String>[
        'Your party fights on its own. Pack kits dump their storms even when combo, a DoT, or empty mana would have locked a single-target nuke.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). The hub hunt still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.160',
      bullets: <String>[
        'Your party fights on its own. Pack damage is closer together — Destruction rains fire on the clump instead of Chaos Bolt, Combat Flurry still hits one extra foe.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). The hub hunt still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.159',
      bullets: <String>[
        'Your party fights on its own. Damage kits now hit packs in the same band — Arms Sweeping and Combat Flurry stay one extra foe, casters drop storms on the clump.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). The hub hunt still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
    ...
    ChangelogRelease(
      version: '1.12.154',
      bullets: <String>[
        'Your party fights on its own. Tap ENTER, then tap the fight — combat is on screen in about a minute.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). The hub hunt still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
    ...
    ChangelogRelease(
      version: '1.12.149',
      bullets: <String>[
        'Floor clear says gold once — no +240g then +240 g again. Hub POWERUPS camera is a side-view camera on the World Path.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). The hub hunt still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.148',
      bullets: <String>[
        'Hub POWERUPS is a camera on the World Path — tap for Ad Tickets and timed boosts. Settings stays in the header.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). The hub hunt still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.147',
      bullets: <String>[
        'Ranked GR20 keeps about a minute on the clock — more kills and tougher packs, not a 46s fuse. Elemental Chain Lightning sits closer to the party.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). The hub hunt still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.146',
      bullets: <String>[
        'Combat Rogue hits with the melee pack again — Sinister Strike, energy, Blade Flurry, and Killing Spree. BM and Elemental stay in band.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). The hub hunt still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.145',
      bullets: <String>[
        'Hub KEY / Vault / Week crumbs hide when the hunt is already KEY, Gauntlet, Ranked GR, Farm Rift, or Ashen. One job on the card.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). The hub hunt still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.144',
      bullets: <String>[
        'Wipe panel stays quiet unless the fight proved a gap (GOLD / BAG / KEY). No guess after two wipes.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). The hub hunt still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
    ...
    ChangelogRelease(
      version: '1.12.142',
      bullets: <String>[
        'Wearing a two-hander and tapping a one-hand or off-hand now swaps the full 1H + off-hand set. TODAY counts that as one better item, not two.',
    ...
    ChangelogRelease(
      version: '1.12.141',
      bullets: <String>[
        'CRAFT is hero → slot → one CRAFT / UPGRADE button. Farm meter sits on the recipe; vault stays folded. Same MORE → CRAFT door.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). TODAY still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.140',
      bullets: <String>[
        'Party Lv100 opens a hub ENDGAME tab with its own map — Gauntlet, Ranked GR, Farm Rift, and Ashen Crown. Not under the 15 zones; KEY still holds the dials.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). TODAY still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.139',
      bullets: <String>[
        'Party Lv100 opens an ENDGAME act on the World Path past Mothveil — tap Gauntlet, Ranked GR, Farm Rift, or Ashen Crown to enter. Same 15 zones; KEY still holds the dials.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). TODAY still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.138',
      bullets: <String>[
        'TODAY chase is clearer: vault payday without season jargon, EQUIP N with slot, plain rebuild-bag tips, and READY detail kept on short phones.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). TODAY still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.137',
      bullets: <String>[
        'Elemental Shamans can Overload: Lightning Bolt, Lava Burst, and Earth Shock sometimes echo a free second bolt.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). TODAY still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.136',
      bullets: <String>[
        'Dungeon floors branch more: hub chambers open side elite alcoves, decoy dead-ends add clutter, corridors wind instead of straight L-turns.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). TODAY still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.135',
      bullets: <String>[
        'Subtlety Shadow Dance vanishes into shadow with haste openers. Combat / Fury / Ret / Frost DK share tuned up; Demonology pet lean trimmed for fairness.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). TODAY still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.134',
      bullets: <String>[
        'Druid forms show on dungeon / GEAR / HUD (owlkin, cat, bear, tree). Balance gains Insect Swarm + Solar/Lunar Eclipse; Feral builds combo into Ferocious Bite.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). TODAY still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.133',
      bullets: <String>[
        'SETTINGS splits into Sound · Display · Bag · Account. Loading splash cycles dungeon stills. Clearer leather/mail helms on the paper doll.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). TODAY still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
    ...
    ChangelogRelease(
      version: '1.12.131',
      bullets: <String>[
        'Kit HUD: capped chips keep identity CDs (PROT Block/Slam, Disc Penance, Fire Pyro/Combustion, Combat Blades/Spree) — no more catalog-order bury.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). TODAY still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.130',
      bullets: <String>[
        'Welcome Back says where you were: hub sanctuary gold only, or mid-dungeon fight with AFK assist — combat gold is never labeled sanctuary.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). TODAY still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.129',
      bullets: <String>[
        'Clearer dailies: MORE · INFO pins Vault · Daily Run · Quests as three different buttons; new THREE DAILIES guide; TODAY crumbs say what tonight is not.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). TODAY still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.128',
      bullets: <String>[
        'Smoother hub: World Path no longer rebuilds every torch flicker — only the HERE ring pulses, after the first paint.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). TODAY still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.127',
      bullets: <String>[
        'AL20 hub header teases the next hunt (party levels / KEY / Gauntlet) — no more MAX that looks like game over.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). TODAY still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.126',
      bullets: <String>[
        'Fairness: Arms / Frost DK / Fury / Ret / Subtlety lifted out of soft LOW — Sweeping Strikes and frost shatter carry the identity.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). TODAY still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.125',
      bullets: <String>[
        'Faster cold start: hub ambience loads first; combat SFX and Play ads/shop warm after the first hub paint.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). TODAY still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.124',
      bullets: <String>[
        'Fairness pass: Destruction Chaos Bolt / Rain / fillers trimmed so live DPS share stays in band.',
        'Melee lean: Arms / Fury / Combat / Frost DK / Ret get a small kitOut bump so plate and rogue kits feel closer to casters.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). TODAY still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
    ...
    ChangelogRelease(
      version: '1.12.118',
      bullets: <String>[
        'Sound: softer owned SFX replace the arcade Kenney clips; lower default SFX/music mix; combat/loot/unlock rate limits; big unlock chime only on zone/Ascend/relic/pet hatch/achievement — everyday buys use a quiet UI tick.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.117',
      bullets: <String>[
        'Hub TODAY: chase owns the big button (Gauntlet / GREATER Ranked GR / Farm Rift / claims) — not a plain ENTER with the hunt buried as a grey chip. READY claims dropped the double “ready” progress echo.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.116',
      bullets: <String>[
        'QUESTS polish: Week and Contract never roll the same goal, and titles drop the clunky “Week: Hard: …” stacking.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). TODAY still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.115',
      bullets: <String>[
        'QUESTS rebuild: five slots now — Daily, Bounty, Side, Week, and Contract. Week refreshes each ISO week; Contract hunts KEY / Gauntlet / Farm Rift / Ranked GR / Ashen Crown once your party is all Lv100.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). TODAY still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.114',
      bullets: <String>[
        'Dungeon floors are bigger: halls instead of closets, the path snakes instead of a straight tunnel, and treasure sits in a side vault off the stairs.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). TODAY still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
    ...
    ChangelogRelease(
      version: '1.12.106',
      bullets: <String>[
        'Dungeon resume paints the floor fast (no stuck Loading floor…). Wipe panel is one clear sheet. Bag auto-clean toasts are throttled. Hub QUIETS vault/KEY/WATCH duplicate chrome; GEAR row says Ranged · Trinkets · Flask.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). TODAY still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.105',
      bullets: <String>[
        'POWERUPS: watch an ad for Ad Tickets, then spend on Sharp Edge / Gold Rush / Full Boost / Away Bonus. Same strength as before (+25% ATK · ×2 gold).',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). TODAY still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.104',
      bullets: <String>[
        'Gold and Essence are back at the top — hub, dungeon HUD, and every menu sheet (GEAR / GOLD / ESSENCE / …).',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). TODAY still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.103',
      bullets: <String>[
        'Clearer dailies: Daily Vault, Daily Run, and Quests are named apart on TODAY / guides. KEEP says Ascend Blessing vs Star Nodes; old heirloom marked legacy (Apex is keep-gear).',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). TODAY still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.102',
      bullets: <String>[
        'One notice system: tips, floor celebrate, and wipe danger share one slot (no separate clear banner fighting toast).',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). TODAY still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.101',
      bullets: <String>[
        'Floor clear popups: one payoff banner when the floor finishes (F1 CLEAR · gold/loot) — no double congrats on last kill, no GO floater, HOLD stays quiet.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). TODAY still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
      version: '1.12.100',
      bullets: <String>[
        'Dungeon map no longer sticks on Loading floor… after clear / resume — tiles paint as soon as floors load.',
        'Sheets close for CLAIM / ENTER / LEAVE; MORE opens QUESTS when TODAY is a claim; Apex Slag farm text stays honest before Gauntlet; gate-locked HUD stays quiet mid-fight.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). TODAY still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
    ...
    ChangelogRelease(
      version: '1.12.89',
      bullets: <String>[
        'TODAY can say Done for today when Vault · Daily · KEY dial are settled (Spire/Boards optional). Header names tonight’s hunt; week ALMOST can own the night. Will points at CODEX.',
        'Shop shows worn compare on UPGRADE. Wipe: Gauntlet/Rift dial tips; timing footnote only with advice. Leave warns FARM loop loss. PUSH boss → ZONE DONE. Ability chips clearer (Guard/Block/Slice/LBomb).',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). TODAY still owns Gauntlet / GREATER / KEY hunts. Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN.',
      ],
    ),
    ChangelogRelease(
    ...
    ChangelogRelease(
      version: '1.12.86',
      bullets: <String>[
        'GEAR and dungeon dolls match: undertunic follows the character (not boxy limbs), and helms sit on the head instead of a full-canvas icon.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault). Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN. TODAY still owns Gauntlet / GREATER / KEY hunts.',
      ],
    ),
    ChangelogRelease(
    ...
    ChangelogRelease(
      version: '1.12.82',
      bullets: <String>[
        'POWER tabs are everyday words: Gold · Shop · Forever (same names the whole game). Gold is one scroll; Shop is flasks and gear; Forever is lasting upgrades.',
    ...
    ChangelogRelease(
      version: '1.12.81',
      bullets: <String>[
        'POWER is one tab row: FORGE · MARKET · CAMP. Forge is one scroll (gold, then KEEP, then APEX) — no ACCOUNT/RUN boxes or GOLD/KEEP/APEX second tabs.',
        'Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN. TODAY still owns Gauntlet / GREATER / KEY hunts.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault).',
      ],
    ),
    ChangelogRelease(
      version: '1.12.80',
      bullets: <String>[
        'Hub World Path is always the scrollable map — tap a zone ring to pick; no Other areas card in front.',
        'Prestige Ascend still Rebuild your bag; AL20 KEEP still has optional REBORN. TODAY still owns Gauntlet / GREATER / KEY hunts.',
        'World Path still Sandy through Mothveil (Tidehold, Ashen Vault, Hollow Grove, Stormwake, Rimeglass, Blightfen, Brassvault).',
      ],
    ),
